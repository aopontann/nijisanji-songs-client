  ...
  return (
    <div>
      ...
      <Typography variant="body" paragraph>
        ...
        タグ一覧にあるタグやライバー一覧の名前をクリックすると、検索欄にキーワードが自動で入力されます。よって、自分で入力する手間が省けて早く検索することができます。<br />
      ...
      <Typography variant="body" paragraph>
        ...
        <br />
        タグは誰でも編集できるようになっています。動画一覧にある<EditIcon fontSize="small"/>をクリックすることでタグ編集できます<br />
