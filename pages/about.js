  ...
  return (
    <div>
      ...
      <Typography variant="body" paragraph>
        ...
        タグ入力欄に追加するタグ名を入力した後、入力欄の右側にあるプラスアイコンをクリックするか、Enterキーを押すとタグが追加されます<br />
        タグを消したい場合、タグ編集画面にあるタグの右にあるバツアイコンをクリックするとタグが消えます。<br />
      ...
      <Typography variant="body" paragraph>
        検索欄に検索したいキーワードを入力してEnterキーか虫眼鏡アイコンをクリックすると、キーワードに関係する動画一覧が表示されます。
        <br />
